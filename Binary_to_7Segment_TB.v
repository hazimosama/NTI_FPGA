...
initial begin
    ...
    $monitor("Binary = %b | 7-Segment = %b",
             binary_TB, segment_TB);


    // Test Case 1
    binary_TB = 4'b0000;
    #10;
    if (segment_TB == 7'b1111110) begin
    ...
    binary_TB = 4'b0001;
    #10;
    if (segment_TB == 7'b0110000) begin
    ...
    binary_TB = 4'b0010;
    #10;
    if (segment_TB == 7'b1101101) begin
    ...
    binary_TB = 4'b0011;
    #10;
    if (segment_TB == 7'b1111001) begin
    ...
    binary_TB = 4'b0100;
    #10;
    if (segment_TB == 7'b0110011) begin
    ...
    binary_TB = 4'b0101;
    #10;
    if (segment_TB == 7'b1011011) begin
    ...
    binary_TB = 4'b0110;
    #10;
    if (segment_TB == 7'b1011111) begin
    ...
    binary_TB = 4'b0111;
    #10;
    if (segment_TB == 7'b1110000) begin
    ...
    binary_TB = 4'b1000;
    #10;
    if (segment_TB == 7'b1111111) begin
    ...
    binary_TB = 4'b1001;
    #10;
    if (segment_TB == 7'b1111011) begin
    ...
    binary_TB = 4'b1010;
    #10;
    if (segment_TB == 7'b0000000) begin
